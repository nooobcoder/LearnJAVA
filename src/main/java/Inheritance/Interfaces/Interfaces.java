...
class Client implements Callback {
    ...
    public void callback(int parent) {
        System.out.println("main.java.Inheritance.Interfaces.Callback called with:  " + parent);
    }
...
abstract class Incomplete implements Callback {
    ...
    /* Here, the class main.java.Inheritance.Interfaces.Incomplete does not implement callback() and must be declared as abstract. Any class that implements an
